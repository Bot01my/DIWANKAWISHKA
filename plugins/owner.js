...
if (Config.WORKTYPE == 'private') {
    ...
    Julie.addCommand({pattern: 'ow', fromMe: true, desc: 'shows the detail of bot owner'}, (async (message, match) => {
        ...
        if (Config.OWNER == 'default') {
            await message.client.sendMessage(message.jid,'*Z BOT Owner Is Diwan Kawishka Dasanayaka🥰*\n\n*පොඩි එකා තමයි කොහොමද දැන ගත්තෙ🙂*\n\n*මොකක් හරි ප්‍රශ්නයක් නම් wa.me/+94786705379 මේකට මැසේජ් එකක් දාන්න🙂*' , MessageType.text);
        }
        else {
